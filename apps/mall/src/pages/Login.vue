    ...
    <div class="card login-card">
      ...
      <form @submit.prevent="onSubmit">
        ...
        <label class="field">
          <span>验证码</span>
          <div class="code-row">
            <input v-model="code" type="text" inputmode="numeric" placeholder="6 位验证码" autocomplete="one-time-code" />
            <button class="btn btn-ghost" type="button" :disabled="cooldown > 0 || sending" @click="sendCode">
